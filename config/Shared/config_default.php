...
$config[QueueConstants::RESOURCE_AWARE_QUEUE_WORKER_ENABLED] = (bool)getenv('RESOURCE_AWARE_QUEUE_WORKER_ENABLED');
...
$config[ContactRequestConstants::MY_CONFIG_VALUE] = 'Hello from my config value!';
